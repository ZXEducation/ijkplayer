...
#--------------------
# Standard options:
FF_CFG_FLAGS="$FF_CFG_FLAGS --enable-pic --disable-cli --enable-static --enable-strip"
FF_CFG_FLAGS="$FF_CFG_FLAGS --prefix=$FF_PREFIX"
FF_CFG_FLAGS="$FF_CFG_FLAGS --sysroot=$FF_SYSROOT --host=${FF_CROSS_PREFIX} --cross-prefix=${FF_CROSS_PREFIX}-"
