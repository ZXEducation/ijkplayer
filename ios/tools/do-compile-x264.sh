...
x264_CFG_FLAGS="--enable-pic --disable-cli --enable-static --enable-strip"
x264_EXTRA_CFLAGS=
x264_CFG_CPU=
...
if [ "$FF_ARCH" = "i386" ]; then
    ...
    x264_CFG_FLAGS="$x264_CFG_FLAGS_ARM $x264_CFG_FLAGS"
...
x264_CFG_FLAGS="$x264_CFG_FLAGS $FF_XCODE_BITCODE --prefix=$FF_BUILD_PREFIX"
...
# else
    echo "$CC \nconfig: $x264_CFG_FLAGS"
    CC="$CC" ./configure \
        $x264_CFG_FLAGS --host=$HOST
    make clean
# fi
